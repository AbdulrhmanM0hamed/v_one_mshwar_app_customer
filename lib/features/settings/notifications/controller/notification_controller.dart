...
import 'package:v_one_mshwar_app_customer/features/settings/notifications/model/notification_model.dart';
...
class NotificationController extends GetxController {
  ...
  Future<void> fetchNotifications({bool refresh = false}) async {
    try {
      ...
      final url =
          API.getNotifications(limit: _limit, offset: _currentOffset) +
          '&user_id=$userId';
      ...
      if (response.statusCode == 200) {
        ...
        log(
          '📥 Response parsed: success=${responseBody['success']}, data=${responseBody['data']}',
        );
        ...
        if (responseBody['success'] == 'success' ||
          ...
          if (responseBody['data'] != null) {
            ...
            final List<NotificationModel> newNotifications = data
