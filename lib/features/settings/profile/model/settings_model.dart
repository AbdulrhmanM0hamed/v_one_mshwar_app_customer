...
class Data {
  ...
  String? serviceJson;
  String? senderId;
  String? showDriverInfoBeforePayment;
  String? passengerCountRequired;
  ...
  Data({
    ...
    this.serviceJson,
    this.senderId,
    this.showDriverInfoBeforePayment,
    this.passengerCountRequired,
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    showDriverInfoBeforePayment =
        json['show_driver_info_before_payment']?.toString() ?? 'no';
    passengerCountRequired =
        json['passenger_count_required']?.toString() ?? 'optional';
  ...
  Map<String, dynamic> toJson() {
    ...
    data['show_driver_info_before_payment'] = showDriverInfoBeforePayment;
    data['passenger_count_required'] = passengerCountRequired;
