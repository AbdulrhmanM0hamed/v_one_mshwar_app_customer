// Flutter Packages
import 'package:v_one_mshwar_app_customer/common/widget/firebase_pagination/src/models/page_options.dart';
import 'package:v_one_mshwar_app_customer/common/widget/firebase_pagination/src/models/view_type.dart';
import 'package:v_one_mshwar_app_customer/common/widget/firebase_pagination/src/models/wrap_options.dart';
      ...
      case ViewType.wrap:
        return SingleChildScrollView(
          ...
          child: Wrap(
            ...
            children: List.generate(items.length + (isLoading ? 1 : 0), (
              int index,
            ) {
              if (index >= items.length) return bottomLoader;
