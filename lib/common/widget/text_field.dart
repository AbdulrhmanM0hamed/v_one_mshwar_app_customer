...
class _CustomTextFieldState extends State<CustomTextField>
  ...
  void _validatePassword(String value) {
    if (value.length < widget.minPasswordLength) {
      _isValid = false;
      _errorMessage = 'password_must_be_at_least_characters'.tr.replaceAll(
        '{count}',
        widget.minPasswordLength.toString(),
      );
    } else {
      _isValid = true;
      _errorMessage = null;
  ...
  OutlineInputBorder _getDefaultErrorBorder() {
    return OutlineInputBorder(
      borderRadius: BorderRadius.circular(_borderRadius),
      borderSide: BorderSide(color: AppThemeData.error200, width: _borderWidth),
    );
  }
  ...
  String _getHelperText() {
    switch (widget.validationType) {
      ...
      case ValidationType.password:
        return 'min_characters'.tr.replaceAll(
          '{count}',
          widget.minPasswordLength.toString(),
        );
      case ValidationType.confirmPassword:
